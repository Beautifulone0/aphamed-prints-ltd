  ...
  return (
    <>
      ...
      <div className="Navigation bar1 hidden lg:block">
        <nav className="flex justify-between items-center ml-10 mr-10 mb-5 mt-5">
          ...
          <div className="lg:flex lg:gap-8 lg:items-center hidden lg:justify-between mt-2 mr-2 lg:mr-30 relative">
            ...
            <br />
            <div className="gap-2 justify-end items-center mr-10 mt-0 pt-0 absolute top-9 left-120 hidden lg:flex">
      ...
      <div className="Navigation bar2 sticky top-0 z-50 left-0 w-full shadow-md">
        <nav
          className={`flex justify-between lg:justify-evenly items-center gap-6 py-4 bg-(--neutral-color) lg:bg-(--primary-color) shadow px-4 transition-all duration-500 backdrop-blur-lg lg:backdrop-blur-lg ${
            isSticky
        ...
        >
          <div className="flex items-center gap-50 justify-evenly lg:justify-between lg:gap-6">
            ...
            <div className="hidden lg:flex items-center ml-70 gap-4">
              <button className="bg-(--secondary-color) p-2 rounded">
                <FaSearch className="h-5 w-5" />
              </button>
              <button className="bg-(--secondary-color) py-2 px-4 rounded font-bold">
                GET A QUOTE
              </button>
            </div>
          </div>
